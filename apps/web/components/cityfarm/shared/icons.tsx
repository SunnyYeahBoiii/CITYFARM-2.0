...
function baseIcon(children: ReactNode, fill = "none") {
  return (
    <svg
      viewBox="0 0 24 24"
      fill={fill}
...
export function DropletIcon() {
  return baseIcon(<path d="M12 3c3 4 5 6.6 5 9.3A5 5 0 0 1 7 12.3C7 9.6 9 7 12 3Z" />);
}
...
export function CloudIcon() {
  return baseIcon(<path d="M7 18h9a4 4 0 0 0 .3-8 5 5 0 0 0-9.5 1.4A3.5 3.5 0 0 0 7 18Z" />);
}
